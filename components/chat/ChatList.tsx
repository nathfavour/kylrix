...
export const ChatList = ({ externalQuery = '' }: { externalQuery?: string }) => {
    ...
    useEffect(() => {
        ...
        const conversationChannel = `databases.${APPWRITE_CONFIG.DATABASES.CHAT}.collections.${...}.documents`;
        const messageChannel = `databases.${APPWRITE_CONFIG.DATABASES.CHAT}.collections.${...}.documents`;
