    ...
    >
          ...
          <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'space-between', alignItems: { xs: 'flex-start', sm: 'center' }, gap: 3 }}>
            <Stack direction="row" alignItems="center" spacing={2}>
                 <Box sx={{ 
                     ...
                     bgcolor: alpha(isEncrypted ? PRIMARY : '#10B981', 0.1),
                     border: `1px solid ${alpha(isEncrypted ? PRIMARY : '#10B981', 0.3)}`,
                     color: isEncrypted ? PRIMARY : '#10B981'
                 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                <Chip 
                  ...
                  sx={{ 
                      ...
                      color: isEncrypted ? PRIMARY : '#10B981',
                      fontWeight: 800,
                      border: `1px solid ${alpha(isEncrypted ? PRIMARY : '#10B981', 0.2)}`,
                  }} 
                />
            </Box>
          </Box>
            ...
            {authorProfile && (
              ...
              >
                <Avatar 
                  ...
                  sx={{ width: 20, height: 20, fontSize: '0.65rem', fontWeight: 900, bgcolor: PRIMARY, color: '#000' }}
                >
                  {getEffectiveDisplayName(authorProfile)[0].toUpperCase()}
                </Avatar>
                <Typography variant="caption" sx={{ fontWeight: 800, color: PRIMARY, fontFamily: 'var(--font-satoshi)' }}>
      ...
      <Box sx={{ position: 'relative', p: { xs: 4, md: 6 }, bgcolor: 'rgba(0, 0, 0, 0.1)' }}>
        ...
        {kind === 'password' && passwordPayload && (
            <Stack spacing={3}>
                ...
                <TextField 
                    ...
                    sx={readOnlyFieldSx} 
                />
                <Button variant="contained" onClick={() => copy('pw', passwordPayload.password)} fullWidth sx={{ py: 1.5, textTransform: 'none', fontWeight: 800, bgcolor: PRIMARY, borderRadius: '14px' }}>
                    Copy Password
                </Button>
        ...
        {kind === 'file' && fileManifest && fileBlobUrl && (
            <Stack spacing={3}>
                ...
                <Button variant="contained" component="a" href={fileBlobUrl} download={fileManifest.originalName} fullWidth sx={{ py: 2, textTransform: 'none', fontWeight: 800, bgcolor: PRIMARY, borderRadius: '14px' }}>
            ...
            <Box sx={{ position: 'relative' }}>
                <IconButton
                    ...
                    sx={{
                        ...
                        top: -12,
                        right: -12,
                        bgcolor: isCopied ? alpha(PRIMARY, 0.1) : '#1C1A18',
                        border: '1px solid',
                        borderColor: isCopied ? PRIMARY : 'rgba(255, 255, 255, 0.05)',
                        borderRadius: '12px',
                        color: isCopied ? PRIMARY : 'rgba(255, 255, 255, 0.4)',
                        transition: 'all 0.2s',
                        zIndex: 2,
      ...
      <Box sx={{ p: 3, bgcolor: '#161412', borderTop: '1px solid rgba(255, 255, 255, 0.03)' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <Typography variant="caption" sx={{ color: PRIMARY, fontWeight: 900, letterSpacing: '0.1em', textTransform: 'uppercase', fontFamily: 'var(--font-clash)' }}>
            SECURE RELAY · KYLRIX
          </Typography>
        </Box>
      </Box>
        ...
        <Container maxWidth="md">
          <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'center', justifyContent: 'space-between', gap: 4 }}>
            ...
            <Button 
              ...
              sx={{ fontWeight: 800, color: PRIMARY, textTransform: 'none' }}
            >
              Back to Send
            </Button>
          </Box>
